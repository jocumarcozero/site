...
const content = {
    pt: {
        ...
        extraTexts: [
            ...
            "A trajetória da Jocum Marco Zero no Recife começou em 2011, quando o contato com crianças e adolescentes em situação de vulnerabilidade extrema transformou a visão missionária de Fernando e Nury. O que inicialmente seria um período temporário de treinamento em aconselhamento tornou-se um chamado profundo para atuar nas ruas da capital pernambucana. Através de visitas semanais noturnas e de uma estratégia sensível de aproximação, como o uso de fotografias que devolviam a dignidade e a identidade àqueles considerados 'invisíveis' pela sociedade, construíram-se laços de confiança que permitiram acessar não apenas os jovens, mas também suas famílias e comunidades. <br><br>Em outubro de 2017, guiados por uma direção divina, o casal fundou a Jocum Marco Zero para atuar de forma focada no coração do Recife. Hoje, a base trabalha na transformação de realidades vulneráveis por meio de ações sociais, discipulado e assistência prática nas áreas de saúde e educação. Utilizando artes, evangelismo e programas de treinamento missionário, o projeto busca ser um reflexo do amor de Deus, focando na restauração familiar e na capacitação de voluntários para promover uma mudança social relevante e duradoura na vida de crianças e adolescentes.",
    ...
    en: {
        ...
        extraTexts: [
            ...
            "YWAM Marco Zero's journey in Recife began in 2011, when contact with children and adolescents in extremely vulnerable situations transformed Fernando and Nury's missionary vision. What was initially supposed to be a temporary period of training in counseling became a deep call to work on the streets of the Pernambuco capital. Through weekly night visits and a sensitive approach strategy, such as using photographs that restored dignity and identity to those considered 'invisible' by society, bonds of trust were built that allowed access not only to the young people, but also to their families and communities.<br><br>In October 2017, guided by divine direction, the couple founded YWAM Marco Zero to act in a focused way in the heart of Recife. Today, the base works on the transformation of vulnerable realities through social actions, discipleship and practical assistance in the areas of health and education. Using arts, evangelism and missionary training programs, the project seeks to be a reflection of God's love, focusing on family restoration and training volunteers to promote relevant and lasting social change in the lives of children and adolescents.",
    ...
    es: {
        ...
        extraTexts: [
            ...
            "La trayectoria de JUCUM Marco Zero en Recife comenzó en 2011, cuando el contacto con niños y adolescentes en situación de vulnerabilidad extrema transformó la visión misionera de Fernando y Nury. Lo que inicialmente sería un período temporal de capacitación en asesoramiento se convirtió en un llamado profundo para actuar en las calles de la capital de Pernambuco. A través de visitas semanales nocturnas y una estrategia sensible de acercamiento, como el uso de fotografías que devolvían dignidad e identidad a los considerados 'invisibles' por la sociedad, se construyeron lazos de confianza que permitieron el acceso no solo a los jóvenes, sino también a sus familias y comunidades. <br><br>En octubre de 2017, guiados por la dirección divina, la pareja fundó JUCUM Marco Zero para actuar de manera enfocada en el corazón de Recife. Hoy, la base trabaja en la transformación de realidades vulnerables a través de acciones sociales, discipulado y asistencia práctica en las áreas de salud y educación. Utilizando artes, evangelismo y programas de capacitación misionera, el proyecto busca ser un reflejo del amor de Dios, enfocándose en la restauración familiar y capacitando a voluntarios para promover un cambio social relevante y duradero en la vida de niños y adolescentes.",
